...
markerstrokewidth = 4;color = :green,markershape = :cross, markersize = 5)
scatter!(f,x,mergerat[p],label = "   + Merge",markerstrokecolor = :red,
markerstrokewidth = 0;color = :red,markershape = :diamond, markersize = 4,
...
savefig("Figures/merge-ratios-arxiv.pdf")
