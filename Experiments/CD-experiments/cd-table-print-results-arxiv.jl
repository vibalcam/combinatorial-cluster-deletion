...
savefig("Figures/mfp-ratios-arxiv.pdf")
...
f
savefig("Figures/mfp-runtimes-arxiv.pdf") 
...
plot!(f,[1, 10^8], [10^4, 10^4],color = :black,linestyle = :dash, linewidth = 1, label="")


f
savefig("Figures/lp-runtimes-arxiv.pdf") 
